...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED ||  ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) || ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
                ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA}, REQUEST_PERMISSIONS_CODE);
            } else {
                ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA}, REQUEST_PERMISSIONS_CODE);
            }

        } else {
            System.out.println("já tem permissão!");
        }
    ...
    public void entrar(View view){
        try {
            ...
            String sql = "SELECT USUARIO, SENHA FROM LOGIN WHERE USUARIO= '" + mEmailView.getText() +
                    "' AND SENHA='" + mPasswordView.getText() + "'";
            ...
            Log.d("maicon", "erro ao validar login - " + e.getMessage());
        }
    }
    ...
    public void cadastrar(View view){
        ...
        try {
            values.put("USUARIO", mEmailView.getText().toString());
            ...
            Log.d("maicon", "erro ao inserir login - " + e.getMessage());
        }
